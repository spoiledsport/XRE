...
namespace Microsoft.Framework.Runtime
{
    internal class DesignTimeProjectReference : IMetadataProjectReference
    {
        ...
        {
            var compilationException = new DesignTimeCompilationException(Name, _response.Errors);
            return new DiagnosticResult(_response.Errors.Any(), _response.Warnings, compilationException.CompilationFailures);
        }
        ...
        public Assembly Load(IAssemblyLoadContext loadContext)
        {
            ...
            {
                throw new DesignTimeCompilationException(Name, _response.Errors);
            }
